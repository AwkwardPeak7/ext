...
abstract class ZeistManga(
    ...
    protected open val statusSelectorList =
        listOf(
            "Status",
            "Estado",
        )

    protected open val authorSelectorList =
        listOf(
            "Author",
            "Autor",
            "الكاتب",
    ...
    protected open val artisSelectorList =
        listOf(
            "Artist",
            "Artista",
            "الرسام",
    ...
    override fun mangaDetailsParse(response: Response): SManga {
        ...
        return SManga.create().apply {
            ...
            genre =
                profileManga.select(mangaDetailsSelectorGenres)
    ...
    open fun getChapterFeedUrl(doc: Document): String {
        ...
        val script =
            doc.selectFirst(scriptSelector)
    ...
    protected open val statusCompletedList =
        listOf(
            "completed",
            "completo",
            "finalizado",
    ...
    protected open val statusHiatusList =
        listOf(
            "hiatus",
            "pausado",
        )

    protected open val statusCancelledList =
        listOf(
            "cancelled",
            "dropped",
            "dropado",
