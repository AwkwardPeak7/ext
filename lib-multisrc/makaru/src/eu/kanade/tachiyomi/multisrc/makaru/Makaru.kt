...
abstract class Makaru(
    ...
    override fun searchMangaRequest(
        ...
        val url =
            apiUrlBuilder("Series", page, MAX_MANGA_RESULTS).apply {
    ...
    override fun pageListParse(response: Response): List<Page> {
        ...
        val script =
            document.selectFirst("script:containsData(data_content)")
    ...
    private fun getMangaFeed(document: Document): Pair<String, MakaruDto> {
        val script =
            document.selectFirst("script:containsData(clwd.run)")
