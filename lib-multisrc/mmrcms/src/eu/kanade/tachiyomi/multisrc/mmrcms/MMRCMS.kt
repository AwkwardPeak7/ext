...
abstract class MMRCMS
    ...
    constructor(
        ...
        protected val detailAuthor = hashSetOf(
            "author(s)",
            "autor(es)",
            "auteur(s)",
            "著作",
        ...
        protected val detailArtist = hashSetOf(
            "artist(s)",
            "artiste(s)",
            "sanatçi(lar)",
            "artista(s)",
        ...
        protected val detailGenre = hashSetOf(
            "categories",
            "categorías",
            "catégories",
            "ジャンル",
        ...
        protected val detailStatusOngoing = hashSetOf(
            "ongoing",
            "مستمرة",
            "en cours",
            "em lançamento",
