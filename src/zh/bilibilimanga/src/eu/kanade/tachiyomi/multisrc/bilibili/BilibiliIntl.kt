...
class BilibiliIntl(private val lang: String) {
    ...
    val failedToRefreshToken: String =
        when (lang) {
    ...
    @Suppress("UNUSED") // In BilibiliComics
    val failedToGetCredential: String =
        when (lang) {
    ...
    private val updatesDaily: String =
        when (lang) {
