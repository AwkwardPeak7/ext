...
abstract class Bilibili(
    ...
    override fun searchMangaRequest(
        ...
        val apiUrl =
            "$baseUrl/$API_COMIC_V1_COMIC_ENDPOINT/".toHttpUrl().newBuilder()
    ...
    override fun mangaDetailsRequest(manga: SManga): Request {
        ...
        val apiUrl =
            "$baseUrl/$API_COMIC_V1_COMIC_ENDPOINT/ComicDetail".toHttpUrl()
                .newBuilder()
                .addCommonParameters()
                .toString()
    ...
    protected open fun imageIndexRequest(
        ...
        val apiUrl =
            "$baseUrl/$API_COMIC_V1_COMIC_ENDPOINT/GetImageIndex".toHttpUrl()
                .newBuilder()
                .addCommonParameters()
                .toString()
    ...
    protected open fun imageTokenRequest(urls: List<String>): Request {
        ...
        val apiUrl =
            "$baseUrl/$API_COMIC_V1_COMIC_ENDPOINT/ImageToken".toHttpUrl()
                .newBuilder()
                .addCommonParameters()
                .toString()
    ...
    private val SharedPreferences.chapterImageQuality
        get() =
            when (getString("${IMAGE_QUALITY_PREF_KEY}_$lang", IMAGE_QUALITY_PREF_DEFAULT_VALUE)!!) {
                "hd" -> "1600w"
                "sd" -> "1000w"
                "low" -> "800w_50q"
                else -> "raw"
