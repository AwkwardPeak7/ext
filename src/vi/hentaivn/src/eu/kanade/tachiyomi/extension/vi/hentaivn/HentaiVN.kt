...
class HentaiVN : ParsedHttpSource(), ConfigurableSource {
    ...
    override val client: OkHttpClient by lazy {
        val baseClient =
            if (preferences.getBoolean(PREF_KEY_ENABLE_CLOUDFLARE_BYPASS, true)) {
    ...
    override fun fetchSearchManga(
        ...
        return when {
            ...
            searchAllFilter.state.isNotEmpty() ->
                client.newCall(
                    GET(
    ...
    override fun searchMangaRequest(
        ...
        val url =
            searchUrl.toHttpUrl().newBuilder().apply {
